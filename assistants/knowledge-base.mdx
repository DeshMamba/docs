...
<Steps>
  <Step title="Open the Knowledge Base tab">
    Go to **Agents** in the sidebar and click the **Knowledge Base** tab.
  </Step>
...
<Steps>
  ...
  <Step title="Select the knowledge base">
    On the **Model tab**, find **Knowledge Base** in the Agent Settings sidebar. Select your knowledge base from the dropdown.
  </Step>
  <Step title="Save">
