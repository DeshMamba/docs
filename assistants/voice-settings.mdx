...
description: "Choose a voice provider, voice, language, speaking speed, and response style for your Chattrvox agent."
---

Voice settings control how your agent sounds to callers.

Voice settings live on the **Model tab** of the agent editor, in the **Agent Settings** sidebar on the right.

## Voice providers

Chattrvox supports multiple voice providers. Each offers different voices, accents, and settings.

| Provider | Notes |
| --- | --- |
| Cartesia | Wide language support. Recommended for most use cases. |
| ElevenLabs | Highly expressive voices. Additional stability and clarity controls. |
| Rime | Natural-sounding voices with low latency option. |
| Hume | Emotionally expressive voices with speed and instant mode controls. |
| Deepgram | Aura 2 voices optimized for real-time conversation. |

Click the play button next to the voice dropdown to preview any voice before selecting it.
...
<Tip>
  Small adjustments — ±0.2 — make a noticeable difference. Stay close to 1.0× for most use cases.
</Tip>
