...
Workspaces are self-contained environments inside your Chattrvox account. Each workspace has its own assistants, campaigns, contact lists, workflows, and credentials — nothing leaks between them. You can create multiple workspaces to separate clients, business units, or use cases, and grant each team member exactly the access they need.
...
When you receive an invitation email, click the **Accept Invitation** link. You will be taken to the Chattrvox sign-in page if you are not already logged in.
